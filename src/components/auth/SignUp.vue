            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="handleSignUp">
                        ...
                        <div class="input-group mb-3">
                            <input v-model="retypePassword" type="password" class="form-control" placeholder="Retype password" />
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-lock"></span>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="icheck-primary">
                                    <input v-model="agreeTerms" type="checkbox" id="agreeTerms" />
                    ...
                    <router-link to="/signin" class="text-center">Already have an account</router-link>
                </div>
            </div>
        </div>
    </div>
